...
A implementacao atual esta na fase host/Python. O Android/NDK ainda e a proxima etapa de integracao.
...
Os testes foram executados em um Acer Nitro 5 com 16 GB de RAM e GTX 1650. O ambiente Python atual usa `torch+cpu`, portanto a GTX 1650 ainda nao participa do treinamento.
...
3. Exportar o checkpoint treinado para ONNX.
4. Repetir paridade PyTorch/ONNX com amostras reais.
5. Criar a aplicacao Android com NDK, JNI e ONNX Runtime Mobile.
6. Medir inferencia no smartphone com CPU, GPU e NNAPI quando suportados.
7. Comparar contra uma CNN densa.
